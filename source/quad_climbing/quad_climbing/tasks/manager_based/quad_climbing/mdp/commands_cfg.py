...
from .commands import UniformVelocityCommand, WorldCentricVelocityCommand, UniformPoseCommand, UniformPose2dCommand
...
class UniformPoseCommandCfg(CommandTermCfg):
    ...
    current_error_visualizer_cfg: VisualizationMarkersCfg = GREEN_ARROW_X_MARKER_CFG.replace(
        prim_path="/Visuals/Command/error_arrow"
    )

    # Set the scale of the visualization markers to (0.1, 0.1, 0.1)
    goal_pose_visualizer_cfg.markers["frame"].scale = (0.1, 0.1, 0.1)
    current_pose_visualizer_cfg.markers["frame"].scale = (0.1, 0.1, 0.1)
    current_error_visualizer_cfg.markers["arrow"].scale = (1, 1, 1)
