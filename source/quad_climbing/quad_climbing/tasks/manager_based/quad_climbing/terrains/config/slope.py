...
SLOPE_TERRAIN_CFG = TerrainGeneratorCfg(
    ...
    sub_terrains={
        "hf_pyramid_slope": terrain_gen.HfPyramidSlopedTerrainCfg(
            vertical_scale= 0.7, proportion=0.8, slope_range=(0.0, 0.785), platform_width=2.0, border_width=0.25
        ),
        "random_rough": terrain_gen.HfRandomUniformTerrainCfg(
            vertical_scale= 0.005, proportion=0.2, noise_range=(0.00, 0.10), noise_step=0.02, border_width=0.25
        )
    }
)